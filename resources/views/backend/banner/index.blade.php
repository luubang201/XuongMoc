...
@section('content')
    <section class="content-header">
        <h1>
            Quản lý Banner  <a href="{{ route('admin.banner.create') }}" class="btn bg-purple btn-flat"><i class="fa fa-plus"></i> Thêm</a>
        </h1>
        <ol class="breadcrumb">
                            ...
                            @foreach($data as $key => $item)
                                <tr class="item-{{ $item->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.banner.edit', ['id' => $item->id ]) }}" class="btn btn-flat bg-purple"><i class="fa fa-pencil"></i></a>
